...
<table width="100%" border="0" cellspacing="0" cellpadding="10" bgcolor="#0d1117" style="border: 1px solid #1f6feb; border-radius: 12px;">
  <tr>
    <td width="65%" valign="top">
      ...
      <p style="color: #c9d1d9; font-size: 14px; line-height: 1.6;">
        From architecting normalized relational databases and designing multi-layered OOP systems to wiring micro-controller sensor nodes for autonomous hazard intervention, I focus on building reliable software with clean code standards.
      </p>
      <div style="color: #8b949e; font-size: 13px;">
        ⚡ <strong>Core Focus:</strong> Deep Learning Workflows • High-Concurrency Backend Logic • Embedded IoT Robotics
      </div>
    </td>
...
<div align="center">
  ...
  <a href="#"><img src="https://img.shields.io/badge/Data_Structures_&_Algorithms-2E7D32?style=flat-square&logoColor=white" /></a>
...
<div align="center">
  <h2 style="color: #58a6ff;">
    <img src="https://raw.githubusercontent.com/Tarikul-Islam-Anik/Animated-Fluent-Emojis/master/Emojis/Objects/Rocket.png" width="28" height="28" /> Featured Engineering Projects
  </h2>
</div>

<table width="100%" border="0" cellspacing="8" cellpadding="12">
  <tr>
    <td width="50%" bgcolor="#0d1117" style="border: 1px solid #30363d; border-radius: 10px;" valign="top">
      <h3 style="color: #58a6ff; margin-top: 0;">🏥 Smart Hospital Management System</h3>
      <p style="color: #8b949e; font-size: 13.5px;">
        A full medical portal built with strict <strong>Java OOP architecture</strong> and <strong>SQL database</strong> connectivity. Handles patient queue management, role-based records, and synchronized doctor scheduling.
      </p>
      <img src="https://img.shields.io/badge/Java-OOP-ED8B00?style=flat-square" />
      <img src="https://img.shields.io/badge/Database-SQL-336791?style=flat-square" />
    </td>
    <td width="50%" bgcolor="#0d1117" style="border: 1px solid #30363d; border-radius: 10px;" valign="top">
      <h3 style="color: #58a6ff; margin-top: 0;">✈️ Flight Reservation System</h3>
      <p style="color: #8b949e; font-size: 13.5px;">
        A relational database system illustrating complex schema design, indexing, and transactional integrity. Enforces strict ACID compliance across passenger seat allocations and ticket queries.
      </p>
      <img src="https://img.shields.io/badge/SQL-Advanced_Queries-336791?style=flat-square" />
      <img src="https://img.shields.io/badge/Architecture-ACID-brightgreen?style=flat-square" />
    </td>
  </tr>
  <tr>
    <td width="50%" bgcolor="#0d1117" style="border: 1px solid #30363d; border-radius: 10px;" valign="top">
      <h3 style="color: #58a6ff; margin-top: 0;">🚒 Smart Automatic Fire Brigade</h3>
      <p style="color: #8b949e; font-size: 13.5px;">
        An embedded autonomous emergency vehicle utilizing <strong>Arduino</strong> and <strong>Digital Logic Design (DLD)</strong>. Uses flame sensor arrays and logic circuits to detect hazard vectors and trigger automated pump suppression.
      </p>
      <img src="https://img.shields.io/badge/Arduino-Robotics-00979D?style=flat-square" />
      <img src="https://img.shields.io/badge/Hardware-DLD-4A154B?style=flat-square" />
    </td>
    <td width="50%" bgcolor="#0d1117" style="border: 1px solid #30363d; border-radius: 10px;" valign="top">
      <h3 style="color: #58a6ff; margin-top: 0;">🌱 Smart Irrigation System</h3>
      <p style="color: #8b949e; font-size: 13.5px;">
        An automated resource management program written in <strong>C++</strong>. Monitors simulated soil hydration parameters through mathematical thresholds to conserve water and regulate supply pumps.
      </p>
      <img src="https://img.shields.io/badge/C++-System_Logic-00599C?style=flat-square" />
      <img src="https://img.shields.io/badge/Embedded-Automation-blueviolet?style=flat-square" />
    </td>
  </tr>
  <tr>
    <td colspan="2" bgcolor="#0d1117" style="border: 1px solid #30363d; border-radius: 10px;" valign="top">
      <h3 style="color: #58a6ff; margin-top: 0;">⛅ Responsive Weather Web Portal</h3>
      <p style="color: #8b949e; font-size: 13.5px;">
        A multi-page responsive web dashboard designed using semantic <strong>HTML5</strong> and structured <strong>CSS3</strong> layouts to render weather metrics across different screen viewports.
      </p>
      <img src="https://img.shields.io/badge/HTML5-Presentation-E34F26?style=flat-square" />
      <img src="https://img.shields.io/badge/CSS3-Modern_Styles-1572B6?style=flat-square" />
    </td>
  </tr>
</table>
...
<div align="center">
  <!-- Reliable GitHub Stats & Top Languages (configured with cache protection & fallback safety) -->
  ...
  <!-- 100% Reliable GitHub Contribution Activity Curve & Summary -->
  <a href="https://github.com/wahab-qadeer">
    <img src="https://github-profile-summary-cards.vercel.app/api/cards/profile-details?username=wahab-qadeer&theme=tokyonight" width="765" alt="Contribution Graph & Repo Timeline" />
  </a>
</div>
